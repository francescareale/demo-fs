...
<html>
    <head>
		...
		<link href="'.$paths['img'].'/favicon.png?v='.$version.'" rel="icon" type="image/x-icon" />';
...
if (Auth::check()) {
    ...
    echo '
			...
			<header class="main-header">
                <a href="" class="logo" title="" target="_blank">
                    <img src="'.App::getPaths()['img'].'/banner.png" class="logo-image" alt="'.tr('OSM Logo').'">
				</a>
            ...
            <aside class="main-sidebar">
                <section class="sidebar">
                    ...
                    <div class="user-panel text-center info" style="height: 60px">
                        <div class="info">
                            <p><a  href="javascript:;" data-old-href="'.$rootdir.'/modules/utenti/info.php">
                                '.$user['username'].'
                            </a></p>
                            <p id="datetime"></p>
                        </div>

                        <a class="image" href="javascript:;" data-old-href="'.$rootdir.'/modules/utenti/info.php">';
